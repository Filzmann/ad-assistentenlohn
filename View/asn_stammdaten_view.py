...
class AsnStammdatenView(tk.Frame):
    ...
    def __init__(self, parent_view):
        ...
        self.buero_label = tk.Label(self, text="Zuständiges Einsatzbüro")
    ...
    def draw(self):
        ...
        self.vorname_label.grid(row=1, column=0, sticky=tk.NW)
        self.vorname_input.grid(row=1, column=1, columnspan=2, sticky=tk.NW)
        self.nachname_label.grid(row=2, column=0, sticky=tk.NW)
        self.nachname_input.grid(row=2, column=1, columnspan=2, sticky=tk.NW)
        self.email_label.grid(row=3, column=0, sticky=tk.NW)
        ...
        self.buero_label.grid(row=7, column=0, sticky=tk.NW)
